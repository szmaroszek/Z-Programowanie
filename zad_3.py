...
class House(Property):
    def __init__(self, area, rooms, price, adress, plot: int):
        ...
        self.plot = plot
    def __str__(self):
        return f'House located in {self.area} area, {self.rooms} rooms, {self.plot} m^2, for a price of ${self.price} USD.\n'
...
class Flat(Property):
    def __init__(self, area, rooms, price, adress, floor):
        ...
        self.floor = floor
    def __str__(self):
        return f'Flat located in {self.area} area, {self.rooms} rooms on floor: {self.floor}, for a price of ${self.price} USD.\n'
